...
import { SidebarLeftIcon } from '@gdsicon/react'
...
function SidebarGroupLabel({ className, render, ...props }: useRender.ComponentProps<'div'>) {
  const defaultProps = {
    className: cn(
      'text-sidebar-foreground/70 flex h-8 shrink-0 items-center rounded-lg px-2 text-xs font-medium ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
