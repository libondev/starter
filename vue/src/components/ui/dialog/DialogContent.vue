...
<template>
  <DialogPortal>
    ...
    >
      ...
      <DialogClose
        class="absolute top-4 right-4 p-0.5 box-border text-xl transition-colors rounded-md hover:bg-secondary"
      >
        <i class="i-carbon-close block" aria-hidden="true" aria-label="close" />
      </DialogClose>
    </DialogContent>
  </DialogPortal>
</template>
